...
export default function LogInForm() {
  //log user in and return an updated user object
  ...
  //when user object is updated push to the customer profile page? or other feature as requested
  useEffect(() => {
    user && router.push(`/customer/${user.id}`);
  }, [user]);
